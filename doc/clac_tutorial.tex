...
%
% This is the tutorial for the CLAC program. It attempts to teach the
% user about most of CLAC's more interesting features.
% ===========================================================================
...
% In case I want to change this later.
\newcommand{\CLAC}{CLAC}
